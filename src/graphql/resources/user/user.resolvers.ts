...
import {verifiTokenResolver} from "../../composable/verify-token.resolver";
...
export const userResolvers = {
    ...
    Query: {
        users: compose(authResolver, verifiTokenResolver)((parent, {first = 10, offset = 0}, {db}: { db: DbConnection }, info: GraphQLResolveInfo) => {
